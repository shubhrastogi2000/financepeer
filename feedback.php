...
if(isset($_POST['submit']))
  {
	...
	if(move_uploaded_file($temp_name,$file_destination)){
		$q = "INSERT INTO files(name) VALUES($file_destination)";
  ...
  //   $querynoti->execute();
	//
	// $sql="insert into feedback (attachment) values (:attachment)";
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<?php
				if($success){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($success); ?> </div><?php }
				if($failed){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($failed); ?> </div><?php }
...
<div class="form-group">
	...
	<label class="col-sm-2 control-label">Choose File<span style="color:red"></span></label>
	<div class="col-sm-4">
